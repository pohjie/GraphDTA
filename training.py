...
from models.cf_ginconv import CFGINConvNet
from utils import *
import time
...
modeling = [GINConvNet, GATNet, GAT_GCN, GCNNet, GINLSTM, GINProtEmb, DirectEmb, CFGINConvNet][int(sys.argv[2])]
...
for dataset in datasets:
    ...
    if ((not os.path.isfile(processed_data_file_train)) or (not os.path.isfile(processed_data_file_test))):
        ...
        train_data = TestbedDataset(root='data', dataset=dataset+'_cf_train')
        test_data = TestbedDataset(root='data', dataset=dataset+'_cf_test')
